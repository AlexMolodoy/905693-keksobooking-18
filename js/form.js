...
(function () {
  window.advInfoForm = document.querySelector('.ad-form');
...
var activatePage = function () {
  ...
  window.advInfoForm.classList.remove('ad-form--disabled');
  ...
  // возможно тут нужно еще добавить что-то для доступности например - window.mainPin.addEventListener('keydown', onMainPinEnterPress);
};
...
var deactivatePage = function () {
  ...
  // возможно тут нужно еще добавить что-то для доступности например - window.mainPin.removeEventListener('keydown', onMainPinEnterPress);
};
